...
subtest 'pull request opened' => sub {
    ...
    like $got, qr!\[INFO\] POST foo, \00303\[pull request opened\] New Pull Request \(\@moznion\)\17 https://github.com/moznion/sandbox/pull/15!;
};
...
subtest 'pull request closed' => sub {
    ...
    my $got = capture_stderr{ $g2i->respond_to_ikachan($req) };
    like $got, qr!\[INFO\] POST foo, \00303\[pull request closed\] New Pull Request \(\@moznion\)\17 https://github.com/moznion/sandbox/pull/15!;
};
...
subtest 'issue reopened' => sub {
    ...
    my $got = capture_stderr{ $g2i->respond_to_ikachan($req) };
    like $got, qr!\[INFO\] POST foo, \00303\[pull request reopened\] New Pull Request \(\@moznion\)\17 https://github.com/moznion/sandbox/pull/15!;
};
...
subtest 'issue synchronize' => sub {
    ...
    my $got = capture_stderr{ $g2i->respond_to_ikachan($req) };
    like $got, qr!\[INFO\] POST foo, \00303\[pull request synchronize\] New Pull Request \(\@moznion\)\17 https://github.com/moznion/sandbox/pull/15!;
};
