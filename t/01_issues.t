...
subtest 'issue opened' => sub {
    ...
    like $got, qr!\[INFO\] POST foo, \00303\[issue opened\] This is new issue \(\@moznion\)\17 https://github.com/moznion/sandbox/issues/13!;
};
...
subtest 'issue closed' => sub {
    ...
    my $got = capture_stderr{ $g2i->respond_to_ikachan($req) };
    like $got, qr!\[INFO\] POST foo, \00303\[issue closed\] This is new issue \(\@moznion\)\17 https://github.com/moznion/sandbox/issues/13!;
};
